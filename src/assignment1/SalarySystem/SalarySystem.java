...
public class SalarySystem {
	...
	public Employee search(String s) {
		...
		return new Employee("no employee has been found",-1, 0);
	}
	...
	public SalarySystem() {
		Employee j = new Employee("Jaap",0, 1700);
		Employee m = new Employee("Fred",1, 2000);
		Employee s = new Employee("Hans",2, 2300);
		addColleague(j);
		addColleague(m);
		addColleague(s);
	}
